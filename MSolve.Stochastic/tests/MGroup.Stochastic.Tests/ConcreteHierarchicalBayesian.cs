...
namespace MGroup.Stochastic.Tests
{
	public class ConcreteHierarchicalBayesian
	{
		...
		private static (IProbabilityDistributionSampler cementSampler, IProbabilityDistributionSampler mortarSampler, IProbabilityDistributionSampler concreteSampler) InitializeSimulation()
		{
			...
			var cementMeasurementValues = new double[1] { 0.002 };
			var cementMeasurementError = new double[1] { 0.0002 };
			...
			var mortarPrior = new MultivariateUniformDistribution(new double[] { 0, 0, 0 }, new double[] { 30, 3, 0.3 });
			var mortarMeasurementValues = new double[1] { 0.00425 };
			var mortarMeasurementError = new double[1] { 0.000425 };
			...
			var concreteMeasurementValues = new double[1] { 0.00005 };
			var concreteMeasurementError = new double[1] { 0.000005 };
