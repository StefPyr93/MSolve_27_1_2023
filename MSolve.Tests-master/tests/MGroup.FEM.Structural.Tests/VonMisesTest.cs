...
namespace MGroup.FEM.Structural.Tests
{
    ...
    {
        [Fact]
        private static void VonMisesPlasticityMaterialPointTest()
        {
            //material properties
            ...
            //initialize arrays
            var maxStrain = 0.01;
            var max_strain = new double[6] { 0.005, 0.00, 0.00, 0.005, 0.00, 0.00 };
            ...
            var material = new VonMisesMaterial3D(youngModulus, poissonRatio, cohesion, 50.0 * 1e9);
